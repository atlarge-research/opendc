...
Running OpenDC results in four output files. The first file ([Task](#task)) contains metrics related to the jobs being executed. 
...
contains all metrics related to the power sources. Finally, the third file ([Service](#service))
