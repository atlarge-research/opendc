...
<div className="container">
    <div className="row">
        <div className="col col--4">
            ...
            <ul>
                <li>Learn how to <a href="/learn/category/getting-started">get started</a> with OpenDC.</li>
                <li>Follow the provided <a href="/learn/category/tutorials">tutorials</a>.</li>
            </ul>
        </div>
        <div className="col col--4">
