...
function JobReportModal({ jobId, isOpen, onClose, hasExports }) {
        ...
        ...(hasExports
            ? [
                  <Button
                      ...
                      variant="secondary"
                      component="a"
                      href={`/api/jobs/${jobId}/exports`}
                      download={`job-${jobId}-exports.zip`}
                      ouiaId="job-report-download-exports"
                  >
                      Download Exports (ZIP)
                  </Button>,
              ]
            : []),
        <Button variant="primary" onClick={onClose} key="close" ouiaId="job-report-close">
            Close
        </Button>,
    ]

    return (
        <Modal variant={ModalVariant.large} isOpen={isOpen} onClose={onClose} title="Job Report" actions={actions} ouiaId="job-report-modal">
            ...
            {!isLoading && logs.length === 0 && !error && (
                <>
                    ...
                    <EmptyState>
                        ...
                        <Title headingLevel="h4" size="lg" ouiaId="job-report-no-issues-title">
            ...
            {!isLoading && error && (
                <div style={{ marginBottom: '20px' }}>
                    <Title headingLevel="h3" size="md" ouiaId="job-report-error-title">
                        Error
                    </Title>
                    <div
                        style={{
